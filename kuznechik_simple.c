...
// This is the basic non-optimized "demonstration" version of the cipher.
// Conforms to incuded doc/GOSTR-bsh.pdf file, which has an internal
// date in September 2, 2014.
...
void kuz_key(kuz_ctx *kuz, const uint8_t key[32])
{
	int i, j;
	w128_t c, x, y, z;
...
void kuz_enc(kuz_ctx *kuz, w128_t *x)
{
	int i, j;
...
void kuz_dec(kuz_ctx *kuz, w128_t *x)
{
	int i, j;
